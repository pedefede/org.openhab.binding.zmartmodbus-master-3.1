...
## OH3.1 Changed by Pedefede:

Since ZmartifyPKR hasn’t update the binding for OH3.1 yet, I tried my best amateur approach.
I updated libraries to make the binding work under OH3.1. (The extra jar-files in zipfolder, and included them in the project)

It currently runs flawless on MY system. It is NOT tested in any other environment. I therefore ABSOLUTELY don't take ANY responsibility. Use at your OWN risk.

Installation:
Use same procedure, as installing ZmartifyPKR’s binding to OH3.0, using the zipfile
